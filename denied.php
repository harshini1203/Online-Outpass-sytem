...
$query = "SELECT a.out_no, b.name,a.go_date,a.return_date,a.reason,a.status FROM outpass a, student b where a.email=b.email and status='Denied'";
$i=0;
$result = $mysqli->query($query);
if(!$result->fetch_assoc()){
  echo'<table border="1" cellspacing="40" cellpadding="20" style="color:white; position:relative; left:350px;"><tr>
  <td>
  No denied outpasses.
    ...
    while ($row = $result->fetch_assoc()) {
      $i=$i+1;
        ...
        echo '<tr id='.$i.'>
                  ...
                  <td>'.$field3name.'</td>
                  <td>'.$field5name.'</td>
                  <td><button class="wrong" ><svg xmlns="http://www.w3.org/2000/svg" width="30" height="46"  class="bi bi-x-circle-fill" viewBox="0 0 16 16">
